...
type Atalho = {
  ...
  rotulo: string
  icone: ReactNode
  /** Tamanho e cor do botão. O WhatsApp é o canal de venda: fica maior. */
  botao: string
...
const atalhos: Atalho[] = [
  {
    href: instagramUrl,
    rotulo: 'Instagram',
    botao: 'h-12 w-12 text-white shadow-ink-950/60 hover:brightness-110',
  ...
  },
  {
    href: whatsappUrl,
    rotulo: 'WhatsApp',
    botao: 'h-14 w-14 bg-ember-500 text-bone-100 shadow-ember-900/50 hover:bg-ember-400',
    icone: (
